...
# The paper first does SFT on a base gpt2-large, but I achieve the same results with this open model
...
for batch in dataloader:
    ...
    # There are many difference generation strategies. As far as I can tell, the same results are achieved with all of these
